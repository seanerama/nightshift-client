...
## Environments
- **release:** {"tag":"v0.1.1","artifact":"nightshift-client-v0.1.1.apk @ GitHub Release v0.1.1"}
- **device:** {"installed":"pending — v0.1.1 sideload + UI-smoke re-run (keyboard fix #13)"}
